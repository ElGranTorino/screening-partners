...
export default class SanctionService {
    ...
    async INSERT_SANCTIONS() {
        ...
        return Promise.all(entries.map(async (sanction) => {
            const { id, pubDate, firstName, lastName, fullName, authority, type, remarks, programs, aliases, addresses, details, documents, nationality, website, list } = sanction;
