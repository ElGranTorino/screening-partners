...
class App {
    ...
    run() {
        try {
            ...
            table.push([colors.blue('Time'), Date.now()], [colors.blue('Launched in'), '2034 ms'], [colors.blue('Environment'), this.NODE_ENV], [colors.blue('Process pid'), '47312'], [colors.blue('Version'), '4.1.2'], [colors.blue('DBMS'), 'Postgres'], [colors.blue('Database host'), 'http://localhost'], [colors.blue('Database port'), '5432'], [colors.blue('Database name'), 'sp_DB'], [colors.blue('Database admin'), 'sp_admin']);
